...
<head>
    ...
    <title>Encuentra tu Superheroe por nombre</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Por Nombre</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Por ID</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section>
        <div class="container">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="nameBusqueda" placeholder="Ingresa el nombre de tu superheroe">
                <label for="floatingInput">Ingresa el nombre de tu superheroe</label>
            </div>
    ...
    <section id="eleccion">
    <h2 class="text-center">Resultados para: <span id="stringBúsqueda"></span></h2>
        <div class="container">
            <div class="contiene-listado-querys"></div>
        </div>
    </section>
    ...
    <script src="assets/js/custom-name.js"></script>
</body>
